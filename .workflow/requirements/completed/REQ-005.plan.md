...
- [ ] 更新的 Skills：req、plan、audit、work、review（添加 Trade-off Record 输出要求）
- [ ] 更新的 flow-router Skill（添加阶段开始前候选全量回放）
- [ ] 更新的 experience-collector Agent（标记来源阶段）
- [ ] 更新的文档：flow.md（候选回放流程说明）
- [ ] 所有变更通过手工验证，符合成功标准 S1-S5
