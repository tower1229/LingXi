...
- 其他辅助 Skills（index-manager, candidate-evaluator, experience-curator, experience-depositor 等；已移除“服务上下文”辅助 Skill）
...
- 检查依赖的 Skills 是否仍然存在（experience-depositor, rules-creator, context-engineering；已移除“服务上下文”辅助 Skill）
