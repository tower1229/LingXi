...
| 分析代码库以获取相关上下文 | 曾有“服务上下文”辅助 Skill（已移除） | 改为直接补齐服务/模块上下文并沉淀为记忆笔记 |
...
（已移除“服务上下文”辅助 Skill）将“补齐服务上下文”从“推荐”改为“复杂需求必选”，并将结论沉淀为记忆笔记：
...
- 补齐服务/模块上下文（必要时沉淀为 `memory/notes/` 的 `Kind=tech` 记忆笔记）
