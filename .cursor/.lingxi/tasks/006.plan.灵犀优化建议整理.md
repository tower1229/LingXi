...
| T3   | F3：在 task-executor 或 vet-executor 中增加「建议先 /plan」的范围/复杂度提示 | -    | 20min | 待开始 |
...
3. **T3**：更新 `.cursor/skills/task-executor/SKILL.md` 或 `.cursor/skills/vet-executor/SKILL.md`  
...
| `.cursor/skills/task-executor/SKILL.md` 或 `vet-executor/SKILL.md` | 更新 | 「建议先 /plan」的范围/复杂度提示 |
