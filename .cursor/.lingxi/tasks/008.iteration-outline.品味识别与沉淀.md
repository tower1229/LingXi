...
| --- | --- | --- | --- | --- | --- |
| task | task-executor/references/ | 用户明显重体验、轻实现成本 | principles：体验优先 / 成本可控；choice 取其一或用户表述映射 | 需求/约束中出现「体验优先」「可多花成本」等信号 | 确认设计理念；映射到预定义 principles/choice 后沉淀 |
