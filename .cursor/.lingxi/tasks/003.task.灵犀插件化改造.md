...
| S2   | 安装插件后，在任意项目中可使用 /task、/init 等命令 | 新工作区安装插件后执行命令 |
...
- [ ] 安装后，/task、/plan、/build、/review、/init、/remember 等命令可用。
...
- **A) `/vet 003`（推荐）**：审查本 task 文档，查漏补缺后再进入规划或实现。
