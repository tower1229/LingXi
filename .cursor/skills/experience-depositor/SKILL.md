...
description: Deposit learnings, constraints, and debugging conclusions to .workflow/context/experience. Use when user confirms compounding via /flow 沉淀 or /remember commands.
---
