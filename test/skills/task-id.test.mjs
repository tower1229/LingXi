...
const LATEST_PATH = path.join(REPO_ROOT, ".cursor", "skills", "task-executor", "scripts", "latest-task-id.mjs");
const NEXT_PATH = path.join(REPO_ROOT, ".cursor", "skills", "task-executor", "scripts", "next-task-id.mjs");
