...
- **可伸缩工作流**：可任意组合、可并行的工作流，兼顾工程严谨与轻便快捷
- **质量资产化**：过程产物、实践经验自动沉淀，让 AI 不止聪明，还懂你
- **知识整合**：基于模型自然语言理解，实现质量资产主动治理，让知识始终保鲜
...
如果您要创建一个新项目，推荐直接基于 LíngXī 模板 [创建 GitHub 仓库 ⇗](https://github.com/new?template_name=LingXi&template_owner=tower1229)。
