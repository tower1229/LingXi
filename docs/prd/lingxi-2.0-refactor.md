...
1. **读取输入**：
   - `.workflow/requirements/in-progress/001.req.<标题>.md`
   - `.workflow/requirements/in-progress/001.plan.<标题>.md`
   - `.workflow/requirements/in-progress/001.testcase.<标题>.md`
...
1. **读取输入**：
   - `.workflow/requirements/in-progress/001.req.<标题>.md`（仅）
