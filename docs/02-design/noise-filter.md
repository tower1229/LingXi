...
本文档定义"明显噪音"的特征，用于在 experience-collector 中自动过滤不值得沉淀的候选。过滤标准基于**内容模式**而非关键词匹配/长度阈值，避免误判。
...
1. **在 experience-collector 中实现**：读取 EXP-CANDIDATE，应用上述判断规则
...
- [经验治理机制设计](./experience-governance.md) - 成长过滤器
