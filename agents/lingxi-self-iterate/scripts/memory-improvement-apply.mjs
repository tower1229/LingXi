...
const DEFAULT_PROPOSAL_REL = ".lingxi/os/improvement-proposal.json";
const DEFAULT_QUEUE_REL = ".lingxi/os/improvement-actions.queue.json";
const APPEND_AUDIT_REL = "hooks/heartbeat-trigger.mjs";
